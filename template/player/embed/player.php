<link href="<?php echo $host; ?>/css/player.css" rel="stylesheet">
<link href="<?php echo $host; ?>/css/system-modal.css" rel="stylesheet">
<link href="<?php echo $host; ?>/css/history-modal.css" rel="stylesheet">
<link href="<?php echo $host; ?>/css/actions-menu-modal.css" rel="stylesheet">
			...
			<div class="col s12">
				...
				<div class="brg-player-details">
					...
					<div class="brg-player-voting">
						...
						<div class="brg-player-votes grey darken-4 white-text">8</div>
...
<script>
	let brgPlayerHost = '<?php echo $host; ?>';
	let brgPlayerBaseUrl = '<?php echo $host; ?>';
</script>
<script src="<?php echo $host; ?>/js/jquery.jplayer.min.js"></script>
<script src="<?php echo $host; ?>/js/js.cookie.min.js"></script>
<script src="<?php echo $host; ?>/js/push.min.js"></script>
<script src="<?php echo $host; ?>/js/push.service-worker.min.js"></script>
<script src="<?php echo $host; ?>/js/player.js"></script>
